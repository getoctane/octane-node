...
const BASE_PATH = "https://api.cloud.getoctane.io".replace(/\/+$/, "");
...
export const CustomersApiFetchParamCreator = function (_configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        customersCustomerNameUsageGet(customerName: string, endTime?: Date, startTime?: Date, meterName?: string, options: any = {}): FetchArgs {
            // verify required parameter 'customerName' is not null or undefined
            if (customerName === null || customerName === undefined) {
                throw new RequiredError('customerName','Required parameter customerName was null or undefined when calling customersCustomerNameUsageGet.');
            }
            const localVarPath = `/customers/{customer_name}/usage`
                .replace(`{${"customer_name"}}`, encodeURIComponent(String(customerName)));
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'GET' }, options);
            const localVarHeaderParameter = {} as any;
...
export const CustomersApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        customersCustomerNameUsageGet(customerName: string, endTime?: Date, startTime?: Date, meterName?: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Error> {
            const localVarFetchArgs = CustomersApiFetchParamCreator(configuration).customersCustomerNameUsageGet(customerName, endTime, startTime, meterName, options);
            return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
                localVarFetchArgs.options.headers["Authorization"] = "Bearer " +(configuration?.apiKey || "UNSET"); return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
...
export const CustomersApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
         ...
         * @throws {RequiredError}
         */
        customersCustomerNameUsageGet(customerName: string, endTime?: Date, startTime?: Date, meterName?: string, options?: any) {
            return CustomersApiFp(configuration).customersCustomerNameUsageGet(customerName, endTime, startTime, meterName, options)(fetch, basePath);
        },
        /**
         * Retrieve all customers for a given vendor.
         * @summary Get All Customers
...
export class CustomersApi extends BaseAPI {
     ...
     * @memberof CustomersApi
     */
    public customersCustomerNameUsageGet(customerName: string, endTime?: Date, startTime?: Date, meterName?: string, options?: any) {
        return CustomersApiFp(this.configuration).customersCustomerNameUsageGet(customerName, endTime, startTime, meterName, options)(this.fetch, this.basePath);
    }
